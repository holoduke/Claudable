  ...
  return (
    <div className="p-6 space-y-6">
      <div>
        ...
        {!isProjectScoped ? (
          <div className="rounded-lg border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 px-4 py-3 text-sm text-gray-600 dark:text-gray-300">
          ...
          <div className="space-y-5">
            <div>
              ...
              <input
                ...
                className="w-full rounded-lg border border-gray-300 dark:border-gray-700 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
            ...
            <div>
              ...
              <input
                ...
                value={projectId}
                disabled
                className="w-full cursor-not-allowed rounded-lg border border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 px-3 py-2 text-gray-500 dark:text-gray-400"
              />
            </div>
