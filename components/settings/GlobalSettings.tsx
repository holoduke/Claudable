                ...
                <div>
                  ...
                  <div className="space-y-4">
                    {Object.entries(tokens).filter(([provider]) => isIntegrationVisible(provider)).map(([provider, token]) => (
                      <div key={provider} className="flex items-center justify-between p-4 bg-gray-50 dark:bg-white/[0.03] rounded-xl border border-gray-200 dark:border-white/[0.08]">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-600 dark:text-gray-300 ">
                              {token ? (
                                <>
                                  Encrypted • Added {new Date(token.created_at).toLocaleDateString()} • Shared by all projects
                                </>
                              ) : (
                                'Not configured'
                              )}
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <button
                            ...
                            className="px-3 py-1.5 text-sm bg-gray-200 dark:bg-white/[0.06] hover:bg-gray-300 dark:hover:bg-white/[0.1] text-gray-700 dark:text-gray-200 rounded-lg transition-all"
                          >
