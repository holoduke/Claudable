...
function dockerfile(): string {
  return `# Auto-generated by Claudable. Generic Next.js (App Router) production image.
FROM node:22-alpine
WORKDIR /app
...
# next start honours the PORT env var; HOSTNAME binds all interfaces
CMD ["npm", "run", "start"]
`;
}

function dockerignore(): string {
  return ['node_modules', '.next', '.git', 'dist', 'build', 'out', '.turbo', '.vercel', '*.log'].join('\n') + '\n';
}
