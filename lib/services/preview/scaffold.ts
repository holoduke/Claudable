// Project bootstrap helpers: package-manager detection, dependency install, root-structure normalization.
...
export async function runInstallWithPreferredManager(
  projectPath: string,
